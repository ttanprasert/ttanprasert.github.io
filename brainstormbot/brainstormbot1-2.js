...
var selectedTopic, userStance, agentStance, temp, agentBackground, agentName, pick;
var countTyping = 0;
var rnd = 0;
var countWord = 0;
var startTime = 0;

const debateTopic = ["Should robots/AI have rights?", "Is AI a threat to humanity?", "Should potential employers consider an applicant’s social media during a job application?", "Can good intentions exonerate one from bad outcomes?", "Are we happier now as a society than in times past?", "Is stealing ever permissible?", "Can we separate arts from the artist?"];
...
function setup() {
  ...
  } else if ((condition == 0 && group == 1) || (condition == 1 && group == 2) || (condition == 2 && group == 3)) {
